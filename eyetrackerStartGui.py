...
class Ui_StartingWindow(object):
    def setupUi(self, StartingWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("icon_1.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_start.setGeometry(QtCore.QRect(20, 380, 120, 50))
        self.btn_start.setObjectName(_fromUtf8("btn_start"))
        
        self.btn_settings = QtGui.QPushButton(self.centralwidget)
        self.btn_settings.setGeometry(QtCore.QRect(290, 380, 50, 50))
        self.btn_settings.setText(_fromUtf8(""))
        
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("icon_2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.lbl_pupil1.setGeometry(QtCore.QRect(580, 270, 30, 16))
        ...
        self.lbl_pupil2.setGeometry(QtCore.QRect(580, 290, 30, 16))
        ...
        self.lbl_pupil3.setGeometry(QtCore.QRect(580, 310, 30, 16))
        ...
        self.lbl_glint2.setGeometry(QtCore.QRect(580, 390, 30, 16))
        ...
        self.lbl_glint1.setGeometry(QtCore.QRect(580, 370, 30, 16))
        ...
        self.lbl_glint3.setGeometry(QtCore.QRect(580, 410, 30, 16))
    ...
    def retranslateUi(self, StartingWindow):
        ...
        self.lbl_pupil1.setText(_translate("StartingWindow", " ", None))
